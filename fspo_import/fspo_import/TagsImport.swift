...
//
//    
//    lazy var groups: Set<SchedUser> = Set(fspoGroups.map({
//        SchedUser(name: $0.name)
//    }))
...
//                             day: weekday.weekday,
//                             isOdd: isOdd,
//                             group_name: fspoLesson.group_name,
//                             prep_name: prepName)
//            } else {
//                insertLesson(name: fspoLesson.name,
//                             place: fspoLesson.place,
...
//            
//        
//        let l = schedUsers.first(where: { $0.name == "Y2337" })?.lessons(isOdd: false, weekday: "Понедельник") ?? []
//        printLessons(l)
////
////
////
